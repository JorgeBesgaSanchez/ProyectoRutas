...
<div class="container-fluid text-center mt-5">
    ...
    <form class="form-signin" name="entrar" method="POST" action="{{ route('paginas.login') }}"
        ...
        <h1 class="h3 mb-3 font-weight-normal">Por favor, escribe tus credenciales</h1>
        ...
        <button id="login" class="btn btn-lg btn-primary btn-block" type="submit">Logearme</button>
    </form>
